...
The minimal correction/verifier extraction was then applied to a separate
working tree based on the same `main` SHA. Its focused extracted slice passed
`53 passed`, and the actual host-local run at
`/tmp/poddown-extracted-clean-host-local-20260815` passed the independent
verifier before and after resume: mono 44.1 kHz MP3, 650.031 seconds, MP3
SHA-256
`b21260de0fbe9e0d63ce8ad7b35d21dd0ab7983efdc3633459d907ee3a20dd15`, package
manifest digest
`d6c1f8cd2aafa6a525ec503111df7b332ce55e29cb5ef64db03d2f0ac0f2ab21`, 307
render requests, one regenerated segment, zero cost, 100% script-derived
critical-token accuracy, and 306 replayed takes on resume. This is fresh
working-tree extraction evidence; it is not a commit, CI result, merge, or
