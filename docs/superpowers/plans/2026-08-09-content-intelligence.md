...
- `PronunciationEntry(entry_id: str, key: str, spoken_form: str, version: str)` and `PronunciationLexicon(scope: LexiconScope, version: str, entries: tuple[PronunciationEntry, ...])` are frozen.
