...
type PublicationCompletionRecorder = Callable[
    [PublicationActivityRequest, PublicationReceipt], object
]
...
def build_durable_publication_activity(
    ...
    *,
    ...
    publication_completion_recorder: PublicationCompletionRecorder | None = None,
) -> ActivityHandler:
    ...
    async def publish_episode(payload: dict[str, Any]) -> dict[str, Any]:
        try:
            ...
            if publication_completion_recorder is not None:
                publication_completion_recorder(request, receipt)
